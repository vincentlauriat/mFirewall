...
//bundle ID
#define BUNDLE_ID "fr.lauriat.mfirewall"

//extension bundle ID
#define EXT_BUNDLE_ID @"fr.lauriat.mfirewall.extension"

//main app bundle id
#define APP_ID @"fr.lauriat.mfirewall.app"

//signing auth
#define SIGNING_AUTH @"Developer ID Application: Vincent LAURIAT (KFLACS69T9)"

//firewall event: new flow
#define MFIREWALL_EVENT @"fr.lauriat.mfirewall.event"

//mfirewall service
#define MFIREWALL_SERVICE_NAME "com_objective_see_firewall"

//install directory
#define INSTALL_DIRECTORY @"/Library/mFirewall"
...
//daemon mach name
#define DAEMON_MACH_SERVICE @"KFLACS69T9.fr.lauriat.mfirewall"
...
//product version url
#define PRODUCT_VERSIONS_URL @"https://lauriat.fr/outils/mfirewall/products.json"

//app name
#define PRODUCT_NAME @"mFirewall"

//product url
#define PRODUCT_URL @"https://lauriat.fr/outils/mfirewall"

//error(s) url
#define ERRORS_URL @"https://lauriat.fr/outils/mfirewall/errors"
...
//login item name
#define LOGIN_ITEM_NAME @"mFirewall Helper"
...
//log file
#define LOG_FILE_NAME @"mFirewall.log"
...
//general error URL
#define FATAL_ERROR_URL @"https://lauriat.fr/outils/mfirewall/errors"
...
//rules changed
#define RULES_CHANGED @"fr.lauriat.mfirewall.rulesChanged"

//extension event
#define EXTENSION_EVENT @"fr.lauriat.mfirewall.extensionEvent"
...
//launch daemon name
#define LAUNCH_DAEMON_BINARY @"mFirewall"

//launch daemon plist
#define LAUNCH_DAEMON_PLIST @"fr.lauriat.mfirewall.plist"

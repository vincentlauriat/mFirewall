...
-(void)windowDidLoad {
    ...
    //set title
    self.window.title = [NSString stringWithFormat:@"mFirewall v%@", getAppVersion()];
    ...
    switch(((NSButton*)sender).tag)
    {
        ...
        case SHOW_ALLOW_EXT:
        {
            ...
            if(@available(macOS 15.0, *)) {
                ...
                //set instructions
                self.approveExtMessage.stringValue = NSLocalizedString(@"2. In System Settings, toggle on the mFirewall extension", @"2. In System Settings, toggle on the mFirewall extension");
            }
            //pre-macOS 15
            ...
            else
            {
                ...
                //set instructions
                self.approveExtMessage.stringValue = NSLocalizedString(@"2. In System Settings, scroll to where it mentions 'mFirewall' and click 'Allow'", @"2. In System Settings, scroll to where it mentions 'mFirewall' and click 'Allow'");
            }

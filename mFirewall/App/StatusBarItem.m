...
-(void)setState
{
    ...
    {
        //update status
        [self.statusItem.menu itemWithTag:status].title = NSLocalizedString(@"mFirewall: disabled", @"mFirewall: disabled");
    ...
    {
        //update status
        [self.statusItem.menu itemWithTag:status].title = NSLocalizedString(@"mFirewall: enabled", @"mFirewall: enabled");

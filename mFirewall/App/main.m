...
int main(int argc, const char * argv[]) {
    ...
    @autoreleasepool {
        ...
        if(YES == [NSProcessInfo.processInfo.arguments containsObject:@"-install"])
        {
            ...
            {
                //err msg
                printf("\nMFIREWALL ERROR: cmdline interface actions require root\n\n");
                goto bail;
            }
            ...
            {
                //error
                printf("\nMFIREWALL ERROR: install failed (see system log for details)\n\n");
                goto bail;
            }
        ...
        else if(YES == [NSProcessInfo.processInfo.arguments containsObject:@"-upgrade"])
        {
            ...
            {
                //error
                printf("\nMFIREWALL ERROR: upgrade failed (see system log for details)\n\n");
                goto bail;
            }
        ...
        if(YES == [NSProcessInfo.processInfo.arguments containsObject:@"-uninstall"])
        {
            ...
            {
                //error
                printf("\nMFIREWALL ERROR: uninstall failed (see system log for details)\n\n");
                goto bail;
            }
            
            //dbg msg
            printf("\nMFIREWALL: uninstalled\n\n");
